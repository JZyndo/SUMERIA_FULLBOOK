...
{
    public class CSDOFScatter : CSPostEffectsBase
    {
        ...
        public enum CSBlurType
        {
            DiscBlur = 0,
            DX11 = 1,
        }

        public enum CSBlurSampleCount
        {
            Low = 0,
            Medium = 1,
            High = 2,
        ...
        public CSBlurType blurType = CSBlurType.DiscBlur;
        public CSBlurSampleCount blurSampleCount = CSBlurSampleCount.High;
        ...
        protected override bool CheckResources()
        {
            ...
            if (supportDX11 && blurType == CSBlurType.DX11)
            {
        ...
        void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            else if ((blurType == CSBlurType.DX11) && dx11bokehMaterial)
            {
            ...
            else
            {
                ...
                int blurPass = (blurSampleCount == CSBlurSampleCount.High || blurSampleCount == CSBlurSampleCount.Medium) ? 17 : 11;
                ...
                else
                {
                    ...
                    Graphics.Blit(source, destination, dofHdrMaterial, blurSampleCount == CSBlurSampleCount.High ? 18 : 12);
                }
            }
