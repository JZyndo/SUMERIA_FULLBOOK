...
public class GooglePlayDownloader
{
	...
	public static void Init(string publicKeyFromGooglePlay)
	{
		if (!RunningOnAndroid())
			return;
	    ...
	    // stuff for LVL -- MODIFY FOR YOUR APPLICATION!
			dl_service.SetStatic("BASE64_PUBLIC_KEY", publicKeyFromGooglePlay);
	...
	public static void DeleteAllOldOBBs(string expansionFilePath)
	{
