...
public class BezierSplineInspector : Editor
{
    ...
    private void OnSceneGUI()
    {
        ...
        var col = new Color(0, 255, 150, 0.8f);
        for (int i = 1; i < spline.ControlPointCount; i += 3)
        {
            ...
            Handles.DrawBezier(p0, p3, p1, p2, col, null, 5f);
            p0 = p3;
        }
        //ShowDirections();
    }
    ...
    {
        var spline = objectTransform.gameObject.GetComponent<BezierSpline>();
        if (spline == null)
            return;
        //Draw here
        ...
        var col = new Color(0, 255, 150, 0.6f);
        for (int i = 1; i < spline.ControlPointCount; i += 3)
        {
